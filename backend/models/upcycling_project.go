...
// UpcyclingProject is a transformation project managed by a provider/artisan.
// Documents the journey from raw/recovered material to finished upcycled product.
type UpcyclingProject struct {
	...
	// Impact statement shown publicly e.g. "150 kg de déchets évités"
	ImpactLabel *string        `gorm:"size:200" json:"impact_label"`
	Status      string         `gorm:"size:20;default:in_progress;index" json:"status"` // in_progress | completed | showcased
...
// ProjectStep is one documented stage in a UpcyclingProject.
